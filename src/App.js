...
const tld = ".Hashira";
const CONTRACT_ADDRESS = "0x1e5A2c8583E4A1dfF2db2Ae20625E3d6F28af306";
		...
		return (
			<div className="form-container">
				...
				<input
					type="text"
					value={record}
					placeholder="Whats your Breathing Style?"
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">&#128293; Hashira Name Service</p>
							<p className="subtitle">
								Record your Hashira name and your Breathing style on the
								blockchain Forever!
							</p>
						</div>
				...
				{/* Render the input form if an account is connected "&&" significan un then como en una setencia if */}
